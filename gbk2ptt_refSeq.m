function gbk2ptt_refSeq(infile)

%take gbk infile and convert to .ptt (tab delimited)
    %designed gbk from BAA-835 RefSeq annotation resource
%.ptt fields: 
%Location / Strand / Length / PID / Gene / Synonym / Code / COG / Product
%793..1353 / - / 561 / WP_012419063.1 / yfgA / Amuc_0001 / AMUC_RS00010	/ - / pooase

%Version _refSeq: for use with RefSeq resource format, e.g. NC_010655.1
